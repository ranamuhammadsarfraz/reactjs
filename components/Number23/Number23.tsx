...
function Number23() {
    ...
    function generate(e: FormEvent) {
        ...
        const abc = "abcdefghijklmnopqrstuvwxyz",
            writeLine = "1234567890~`!#$^()_-+={[}]|\:;'<,>.?/" + '"' + abc + abc.toUpperCase()
    ...
    return (
        <main className="p-2.5 w-full h-screen bg-gray-600 flex justify-evenly items-center flex-col text-gray-200">
            ...
            <form onSubmit={generate} className="grid">
                <input onChange={(turn) => setValueInput(turn.target.value)} value={valueInput} className="p-3 text-black" type="number" required max="16" min="6" placeholder="Password Length *" />
            ...
            <Link href="https://rmsencode.com">Developed by Rana Muhammad Sarfraz</Link>
        </main>
    )
}
